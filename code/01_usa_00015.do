...
/* 
The program was saved as part of the IPUMS
data download and was modified by Amanda Kreider.
Updated: 2023-07-18

This file constructs the ACS dataset 
from the raw IPUMS USA data.

It takes about 4-7 minutes to run.
*/
...
quietly infix                 ///
  ...
  byte    hispan     99-99    ///
  int     hispand    100-102  ///
  byte    hcovany    103-103  ///
  byte    hcovpriv   104-104  ///
  byte    hinscaid   105-105  ///
  byte    hinscare   106-106  ///
  byte    hinsva     107-107  ///
  byte    empstat    108-108  ///
  byte    empstatd   109-110  ///
  byte    classwkr   111-111  ///
  byte    classwkrd  112-113  ///
  int     occ        114-117  ///
  int     occ2010    118-121  ///
  int     ind        122-125  ///
  byte    diffrem    126-126  ///
  byte    diffphys   127-127  ///
  byte    diffmob    128-128  ///
  byte    diffcare   129-129  ///
  using "${data}/acs/usa_00015.dat"
...
save "${data}/built/acs_data.dta", replace
